...
import com.lby.my12306.biz.ticketservice.common.enums.RegionStationQueryTypeEnum;
import com.lby.my12306.biz.ticketservice.dao.entity.RegionDO;
import com.lby.my12306.biz.ticketservice.dao.entity.StationDO;
import com.lby.my12306.biz.ticketservice.dao.mapper.RegionMapper;
...
import com.lby.my12306.framework.starter.cache.core.CacheLoader;
import com.lby.my12306.framework.starter.cache.toolkit.CacheUtil;
import com.lby.my12306.framework.starter.common.enums.FlagEnum;
    ...
    public List<RegionStationQueryRespDTO> listRegionStation(RegionStationQueryReqDTO requestParam) {
        ...
        LambdaQueryWrapper<RegionDO> queryWrapper = switch (requestParam.getQueryType()) {
            ...
            case 1 -> Wrappers.lambdaQuery(RegionDO.class)
                    .in(RegionDO::getInitial, RegionStationQueryTypeEnum.findSpellsByType(1));
            case 2 -> Wrappers.lambdaQuery(RegionDO.class)
                    .in(RegionDO::getInitial, RegionStationQueryTypeEnum.findSpellsByType(2));
            case 3 -> Wrappers.lambdaQuery(RegionDO.class)
                    .in(RegionDO::getInitial, RegionStationQueryTypeEnum.findSpellsByType(3));
            case 4 -> Wrappers.lambdaQuery(RegionDO.class)
                    .in(RegionDO::getInitial, RegionStationQueryTypeEnum.findSpellsByType(4));
            case 5 -> Wrappers.lambdaQuery(RegionDO.class)
                    .in(RegionDO::getInitial, RegionStationQueryTypeEnum.findSpellsByType(5));
