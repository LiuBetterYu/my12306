package com.lby.my12306.biz.ticketservice.service.handler.ticket.tokenbucket;
...
import com.lby.my12306.biz.ticketservice.dao.mapper.SeatMapper;
...
import com.lby.my12306.biz.ticketservice.dto.domain.RouteDTO;
import com.lby.my12306.biz.ticketservice.dto.domain.SeatTypeCountDTO;
...
import com.lby.my12306.framework.starter.bases.Singleton;
import com.lby.my12306.framework.starter.cache.DistributedCache;
import com.lby.my12306.framework.starter.common.toolkit.Assert;
...
public final class TicketAvailabilityTokenBucket {
    ...
    public boolean takeTokenFromBucket(PurchaseTicketReqDTO requestParam) {
        ...
        if (!hasKey) {
            ...
            lock.lock();
            try {
                hasKey = distributedCache.hasKey(actualHashKey);
                if (!hasKey) {
                    ...
                    for (RouteDTO each : routeDTOList) {
                        ...
                        for (SeatTypeCountDTO seatTypeCountDTO : seatTypeCountDTOList) {
                            String buildCacheKey = StrUtil.join("_", each.getStartStation(), each.getEndStation(), seatTypeCountDTO.getSeatType());
                            ticketAvailabilityTokenMap.put(buildCacheKey, String.valueOf(seatTypeCountDTO.getSeatCount()));
                        }
                    }
