package com.lby.my12306.biz.ticketservice.common.constant;
...
public final class RedisKeyConstant {
     ...
     */
    public static final String TRAIN_STATION_STOPOVER_DETAIL = "my12306-ticket-service:train_station_stopover_detail:";

    /**
     * 用户购票分布式锁 Key
     */
    public static final String LOCK_PURCHASE_TICKETS = "${unique-name:}my12306-ticket-service:lock:purchase_tickets_%s";

    /**
     * 列车购买令牌桶，Key Prefix + 列车ID
     */
    public static final String TICKET_AVAILABILITY_TOKEN_BUCKET = "my12306-ticket-service:ticket_availability_token_bucket:";

    /**
     * 列车购买令牌桶加载数据 Key
     */
    public static final String LOCK_TICKET_AVAILABILITY_TOKEN_BUCKET = "my12306-ticket-service:lock:ticket_availability_token_bucket:%s";

    /**
     * 用户购票分布式锁 Key v2
     */
    public static final String LOCK_PURCHASE_TICKETS_V2 = "${unique-name:}my12306-ticket-service:lock:purchase_tickets_%s_%d";
