...
import com.lby.my12306.biz.userservice.common.enums.VerifyStatusEnum;
import com.lby.my12306.biz.userservice.dao.entity.PassengerDO;
import com.lby.my12306.biz.userservice.dao.mapper.PassengerMapper;
import com.lby.my12306.biz.userservice.dto.req.PassengerRemoveReqDTO;
import com.lby.my12306.biz.userservice.dto.req.PassengerReqDTO;
import com.lby.my12306.biz.userservice.dto.resp.PassengerActualRespDTO;
import com.lby.my12306.biz.userservice.dto.resp.PassengerRespDTO;
import com.lby.my12306.biz.userservice.service.PassengerService;
...
import com.lby.my12306.framework.starter.user.core.UserContext;
...
import static com.lby.my12306.biz.userservice.common.constant.RedisKeyConstant.USER_PASSENGER_LIST;
...
public class PassengerServiceImpl implements PassengerService {
    ...
    public List<PassengerRespDTO> listPassengerQueryByUsername(String username) {
        ...
        return Optional.ofNullable(actualUserPassengerListStr)
                .map(each -> JSON.parseArray(actualUserPassengerListStr, PassengerDO.class))
    ...
    public List<PassengerActualRespDTO> listPassengerQueryByIds(String username, List<Long> ids) {
        ...
        return JSON.parseArray(actualUserPassengerListStr, PassengerDO.class)
                .stream().filter(each -> ids.contains(each.getId()))
    ...
    private String getActualUserPassengerListStr(String username) {
        return distributedCache.safeGet(
                ...
                String.class,
                () -> {
                    LambdaQueryWrapper<PassengerDO> lambdaQueryWrapper = Wrappers.lambdaQuery(PassengerDO.class)
                            .eq(PassengerDO::getUsername, username);
                    List<PassengerDO> passengerDOList = passengerMapper.selectList(lambdaQueryWrapper);
