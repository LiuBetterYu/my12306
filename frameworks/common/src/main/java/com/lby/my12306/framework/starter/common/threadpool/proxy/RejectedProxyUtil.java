...
package com.lby.my12306.framework.starter.common.threadpool.proxy;

import com.lby.my12306.framework.starter.common.toolkit.ThreadUtil;
...
public final class RejectedProxyUtil {
    ...
    public static void main(String[] args) {
        ThreadPoolExecutor threadPoolExecutor =
                new ThreadPoolExecutor(1, 3, 1024, TimeUnit.SECONDS, new LinkedBlockingQueue<>(2));
